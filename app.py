...
"info": "この図記号は配線用遮断器（ブレーカ）だよ。過電流を防ぐために使われる保護装置だね。" 
    ...
    },
    {
        ...
        "correct": "ハ",
        "info": "水を20 K上昇させるのに必要な熱量は60×4.2×20=5040 kJ となり、これは 1.4 kW･h に相当するよ。熱効率100％なので、この値がそのまま必要な電力量になるんだ。",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
        ...
        "correct": "ハ",
        "info": "各線電流20Aが流れるデルタ結線では、線電流と相電流が等しく、相電圧は𝑉=𝐼×𝑅=20×6=120Vになるよ。デルタ結線の線間電圧は相電圧の3倍だから、120×3≈208Vとなるんだ",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
        "q": "図の三相3線式回路で×印の箇所が断線した場合、負荷の全消費電力[kW]は。負荷抵抗30Ωとし、配線の抵抗は無視し、電源電圧は一定とする。",
        "img": "images4.jpg", 
        "choices": ["イ. 0.7", "ロ. 0.9", "ハ. 1.3", "ニ. 2.0"],
        "correct": "ニ",
        "info": "デルタ結線で1線が断線すると、残った2つの抵抗だけが電源に接続され、それぞれに200Vがそのまま加わるよ。各抵抗の消費電力は200²/30≈1.33kWで、2つ分を合計すると約2.0kWになるね。",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
        ...
        "correct": "ハ",
        "info": "直径2.0mmのビニル絶縁電線を4本同一管内に収めると、低圧屋内配線では「4本以上で0.7の低減係数」を適用するよ。基準許容電流31Aに低減係数0.7を掛けると31×0.7=21.7Aとなり、四捨五入して22Aが許容電流となるんだ。",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
        "q": "金属線ぴ工事に使用する金属製線ぴに関する記述として，正しいものは。",
        "choices": ["イ.壁等に固定して絶縁電線(屋外用ビニル絶縁電線を除く。)を収める。", "ロ.コンクリート床内に埋め込んで絶縁電線を収める。", "ハ.本体と導体とが一体となった材料で，照明器具等を直接取り付けて使用す
る。", "ニ.天井等につるし，ケーブルを並べて支持するのに用いる。"],
        "correct": "イ",
