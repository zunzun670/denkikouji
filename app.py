...
"info": "この図記号は配線用遮断器（ブレーカ）だよ。過電流を防ぐために使われる保護装置だね。" 
    ...
    },
    {
        ...
        "correct": "ハ",
        "info": "デルタ結線では、線電流と抵抗に流れる電流（相電流）が同じになるから、まず抵抗1つに流れる電流は20Aと考えて大丈夫だよ。その抵抗の電圧は𝑉=𝐼×𝑅=20×6=120V。デルタ結線では、線間電圧はこの相電圧の3倍になるという決まりがあるから、120×3≈208Vとなる。  n/「デルタは線間＝相電圧×√3」が大切！",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
    ...
    },
    {
        ...
        "correct": "ハ",
        "info": "直径2.0 mm のビニル絶縁電線は、本来「31A」が1本あたりの基準となる許容電流だよ。でも、同じ管の中に4本以上の電線を入れると、熱がこもりやすくなるため「0.7」の低減係数を掛ける決まりになっている。つまり、31𝐴×0.7=21.7𝐴となり、実際に使える許容電流はこれより小さくなる。  n/係数0.7と基準31Aの組み合わせを覚えておくと安心だよ。",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
