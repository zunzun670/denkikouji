...
"info": "この図記号は配線用遮断器（ブレーカ）だよ。過電流を防ぐために使われる保護装置だね。" 
    ...
    },
    {
        ...
        "correct": "ハ",
        "info": "デルタ結線では、線電流と抵抗に流れる電流（相電流）が同じになるから、まず抵抗1つに流れる電流は20Aと考えて大丈夫だよ。その抵抗の電圧は𝑉=𝐼×𝑅=20×6=120V。デルタ結線では、線間電圧はこの相電圧の3倍になるという決まりがあるから、120×3≈208Vとなる。「デルタは線間＝相電圧×√3」が大切！",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
        ...
        "correct": "ニ",
        "info": "デルタ結線で1本の線が切れると、三角形のうち2つの抵抗だけが電源につながった状態になる。この2つの抵抗には、それぞれ200Vがそのまま加わるから1つあたりの電力は200²÷30≈1.33kWになるね。残った2つの抵抗はどちらも同じように電力を消費するよ。だから全体の消費電力は1.33×2≈2.0kWとなるんだ。「デルタ結線で1線断線 → 2つだけ動く」という流れを覚えておいてね。",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
