...
"info": "この図記号は配線用遮断器（ブレーカ）だよ。過電流を防ぐために使われる保護装置だね。" 
    ...
    },
    {
        ...
        "correct": "ハ",
        "info": "直径2.0 mm のビニル絶縁電線は、本来「31A」が1本あたりの基準となる許容電流だよ。でも、同じ管の中に4本以上の電線を入れると、熱がこもりやすくなるため「0.7」の低減係数を掛ける決まりになっている。つまり、31𝐴×0.7=21.7𝐴となり、実際に使える許容電流はこれより小さくなる。係数0.7と基準31Aの組み合わせを覚えておくと安心だよ。",
        "source": "出典：令和7年度下期 第二種電気工事士試験（学科）"
    },
    {
